namespace Bijuteri
{
    ...
    public partial class Model1 : DbContext
    {
        ...
        public virtual DbSet<SatisDurum> SatisDurum { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OzellikTip>()
                .HasMany(e => e.UrunOzellik)
                .WithRequired(e => e.OzellikTip)
                .HasForeignKey(e => e.OzellikTipiID)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<SatisDurum>()
                .HasMany(e => e.Satis)
                .WithOptional(e => e.SatisDurum)
                .HasForeignKey(e => e.SiparisDurumID);
